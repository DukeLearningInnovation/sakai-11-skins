...
if("null"!==document.getElementById("Mrphs-footer--details__info")){var buildTimeHtml="\x3cdt\x3eSkin Version:\x3c/dt\x3e\x3cdd\x3e9d9fafa\x3c/dd\x3e";document.getElementById("serverTime").insertAdjacentHTML("afterend",buildTimeHtml)}var logoContainer=document.querySelector(".Mrphs-headerLogo--institution"),homeLinkContainer=document.querySelector(".Mrphs-sitesNav__menuitem--myworkspace .link-container");logoContainer.style.cursor="pointer";
